...
public class output2dgimmick {

    [MenuItem("Window/2Dギミック出力")]
    public static void ShowWindow()
    {
        ...
        StreamWriter sw = new StreamWriter("C:/GitHub/kbcGames_jr/kbcgames_jr/Source/Game/Gimmick2DInfo.h", false, Encoding.UTF8);
        sw.Write(headerTxt);
        sw.Close();
    }
}
